...
(function(){
  ...
  var searchOffset=0,allDateOptions=[],batchDateOptions=[],lastQualityMessage='',batchCompleted=0,batchTotal=0,batchErrors=0,selectedAddress=null,addressTimer=null,addressSequence=0,addressOptions=[],addressActive=-1,calendarTitleInput=null,calendarTitleEdited=false,lastAutoCalendarTitle='';
  ...
  function resetForm(){lastNameInput.value='';firstNameInput.value='';addressInput.value='';phoneInput.value='';emailInput.value='';customerNotesInput.value='';entryInformationInput.value='';visitsContainer.innerHTML='';dateSuggestions.style.display='none';dateSuggestions.innerHTML='';selectedAddress=null;calendarTitleInput=null;calendarTitleEdited=false;lastAutoCalendarTitle='';closeAddressList();showAddressStatus('');addressDetails.style.display='none';addressDetails.textContent='';visitCounter=0;searchOffset=0;allDateOptions=[];batchDateOptions=[];lastQualityMessage='';batchCompleted=0;batchTotal=0;batchErrors=0;addVisit('');addressInput.focus();}
