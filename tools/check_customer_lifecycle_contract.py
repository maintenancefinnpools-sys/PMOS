...
def main() -> None:
    ...
    require(add, "options.draft=true", "pre-save inline Add Customer location draft", failures)
    require(add, "createDraftLocations", "additional-location creation after primary customer", failures)
    ...
    require(lifecycle, "Additional Contacts", "combined deduplicated profile contacts", failures)
