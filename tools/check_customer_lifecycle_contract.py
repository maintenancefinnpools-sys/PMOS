...
def main() -> None:
    ...
    require(shared_equipment, "'PhProbePartNumber','522186'", "IntelliChem pH probe part number", failures)
    require(shared_equipment, "'OrpProbePartNumber','522187'", "IntelliChem ORP probe part number", failures)
    require(shared_equipment, ".automation-fields>label", "matching automation-field typography", failures)
    require(equipment_enhancements, "type:'FLOW_CELL'", "detailed chemistry flow-cell equipment", failures)
    require(equipment_enhancements, "pumpMotorPartNumber", "chemistry dosing-motor part number", failures)
