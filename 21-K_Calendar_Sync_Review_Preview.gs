 ...
 * reviewed queue worker only after the user approves the preview.
 */
...
<div class="section"><div class="section-head"><h3>Reviewed Event Actions</h3>${reviewed.length > 5 ? '<button id="toggleReviewList" class="toggle" type="button" onclick="toggleReviewedEvents()">Show More</button>' : ''}</div><div class="metrics">
