...
<div class="section"><div class="section-head"><h3>Maintenance</h3><select id="customerStatus" class="status-select" aria-label="Customer status"><option>Active</option><option>Inactive</option><option>Paused</option></select></div><div class="grid"><div class="field"><label>Calendar title</label><input id="calendarTitle"></div><div class="field"><label>Frequency</label><select id="frequency"><option value=""></option><option>Weekly</option><option>Twice Weekly</option><option>Bi-Weekly</option><option>Monthly</option><option>On Request</option></select></div><div class="field wide"><label>Current route</label><div class="route-view"><input id="routeSummary" disabled><button id="changeRoute" class="route-change" type="button">Change</button></div></div><div class="wide" style="display:grid;grid-template-columns:minmax(0,1fr) 150px;gap:12px"><div class="field"><label>Service address</label><div class="address-wrap"><input id="address" autocomplete="off"><div id="addressList" class="address-list"></div></div></div><div class="field"><label>Service start</label><input id="serviceStartDate" type="date"></div></div><div id="routeBox" class="route-box"><div id="routeMessage" class="route-message">Choose a recommendation or enter a manual route placement.</div><div id="recommendations" class="recommendations"></div><div style="margin-top:12px;padding:11px;border:1px solid #cedce2;border-radius:9px;background:#f8fafb"><div style="margin-bottom:9px;font-size:11px;font-weight:900">Manual route placement</div><div style="display:grid;grid-template-columns:repeat(4,minmax(0,1fr));gap:9px"><div class="field"><label>Primary service day</label><select id="manualDay"><option value="">Select</option><option>Monday</option><option>Tuesday</option><option>Wednesday</option><option>Thursday</option><option>Friday</option></select></div><div id="manualSecondDayField" class="field" style="display:none"><label>Second service day</label><select id="manualSecondDay"><option value="">Select</option><option>Monday</option><option>Tuesday</option><option>Wednesday</option><option>Thursday</option><option>Friday</option></select></div><div id="manualWeekField" class="field"><label>Rotation week</label><select id="manualWeek"><option value="1">Week 1</option><option value="2">Week 2</option><option value="3">Week 3</option><option value="4">Week 4</option></select></div><div class="field"><label>Stop position</label><input id="manualStop" type="number" min="1" value="1"></div><button id="applyManualRoute" type="button" class="route-change" style="align-self:end">Use Manual Placement</button></div></div></div></div></div>
<div class="section"><div class="section-head"><h3>Property information</h3></div><div class="grid"><div class="field"><label>Entry information</label><textarea id="entryInformation"></textarea></div><div class="field"><label>Customer notes</label><textarea id="notes"></textarea></div></div></div><div class="section"><div class="section-head"><h3>Bodies of water & equipment</h3></div><div id="equipmentContext" class="context" style="padding-top:15px">Loading equipment…</div></div></div>
