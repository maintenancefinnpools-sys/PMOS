...
</script></body></html>`).setWidth(720).setHeight(600);

  if (taskType === 'CALENDAR_AUDIT') {
    SpreadsheetApp.getUi().showModelessDialog(html, taskTitle);
  } else {
