...
syncButton.onclick=function(){syncButton.disabled=true;stage.textContent='Opening Calendar Sync…';google.script.run.withSuccessHandler(function(){google.script.host.close();}).withFailureHandler(fail).openIntegratedCalendarSyncFromAudit();};
