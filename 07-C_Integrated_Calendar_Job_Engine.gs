/**
 * Calendar Repair compatibility window.
 *
 * The former integrated Job Center exposed obsolete Calendar Sync and
 * reconciliation entry points. Calendar Sync now belongs exclusively to the
 * reviewed Audit -> Review Session -> durable queue -> Job Center workflow.
 * This module remains only as the dedicated historical Calendar Repair UI.
 */
