/**
 * PMOS shared safety foundation for resumable, time-limited operations.
 *
 * This module deliberately contains no Calendar business logic. It supplies
 * locking, execution deadlines, checkpoints, continuation metadata, and safe
 * cleanup for the Job Runtime and future long-running PMOS operations.
 */
