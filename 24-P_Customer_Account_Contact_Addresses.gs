...
function pmosAccountBillingAddressStyles_() {
  return '.billing-link{padding:0;border:0;background:transparent;color:#0f5470;font:inherit;font-size:12px;font-weight:900;cursor:pointer}.billing-intro{margin:5px 0 0;color:#6f7d84;font-size:11px;line-height:1.45}.billing-panel{display:none;margin-top:10px;padding:11px;border:1px solid #cfdce2;border-radius:9px;background:#f7fafb}.billing-panel.open{display:block}.billing-grid{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:9px}.billing-grid .wide{grid-column:1/-1}.billing-help{margin:7px 0 0;color:#6f7d84;font-size:11px;line-height:1.45}@media(max-width:760px){.billing-grid{grid-template-columns:1fr}.billing-grid .wide{grid-column:auto}}';
}
