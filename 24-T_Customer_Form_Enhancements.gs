...
(function(){
  ...
  function addSolarTypeOption(input){if(!input)return;var listId=input.getAttribute('list')||input.getAttribute('data-smart-list'),list=listId&&document.getElementById(listId);if(list&&!Array.prototype.some.call(list.options,function(option){return String(option.value||'').toLowerCase()==='solar'})){var option=document.createElement('option');option.value='Solar';list.appendChild(option)}}
