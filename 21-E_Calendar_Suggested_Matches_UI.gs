...
function showCalendarSuggestedMatchesReview() {
  ...
  const html = HtmlService.createHtmlOutput(buildPmosAuditReviewHtml_('Suggested Customer Matches', body, footer, script) + '<style>' +
    '.instructions.blue{background:#e4f0f5;color:#0f5470;border-color:#bfd9e5;border-left-color:#017db1}.match-row{background:#f9fafb;border:1px solid #d2dade;border-left:5px solid #017db1;border-radius:9px;margin:9px 0;box-shadow:0 3px 10px rgba(46,56,66,.045)}.match-row.selected{background:#edf1f3;opacity:1}.match-summary{display:grid;grid-template-columns:22px 1fr auto;gap:9px;align-items:start;padding:10px;cursor:pointer}.compact span{display:block}.type-badge,.exception-badge{display:inline-block!important;width:max-content;border-radius:999px;margin-bottom:4px}.type-badge{font-size:10px;font-weight:800;padding:2px 7px;background:#e4f0f5;color:#0f5470}.exception-badge{display:none!important;background:#e4f0f5;color:#0f5470;border:1px solid #bfd9e5;font-size:12px;font-weight:900;padding:4px 9px;letter-spacing:.2px}.selected .exception-badge{display:inline-block!important}.match-target{font-size:13px;color:#0f5470;margin-top:3px}.expand{padding:5px 8px;background:#f2f5f6;color:#0f5470;border-color:#bfd9e5}.expanded{display:none;padding:0 12px 12px 41px;font-size:13px;line-height:1.5;background:#edf1f3}.expanded.open{display:block}</style>').setWidth(820).setHeight(700);
